...
/*
 ...
 using stack  push root into stack go left then right and simantaniously push the root->node
  whenever we found !root->left and !root->right just pop  top element
